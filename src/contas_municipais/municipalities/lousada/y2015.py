...
# Some pct values use 1 decimal place ("97,5", "93,5") — base _PT_NUM requires exactly 2.
...
def parse(files: dict[str, Path]) -> ParseResult:
    ...
    if pdf is None:
        raise FileNotFoundError("No PDF found for 2015 (expected key 'prestacao_contas' or 'other')")
